...
export class ListenerService {
    ...
    invokeRegistrationFromRecord(userKey: string, connection: ClientConnection): Promise<ClientEventRegistration> {
        ...
        const invocation = new Invocation(this.client.getInvocationService(), registerRequest);
    ...
    registerListener(codec: ListenerMessageCodec,
        ...
        this.logger.trace('ListenerService', 'registerListener called');
        const activeConnections = this.client.getConnectionRegistry().getConnections();
        ...
        for (const connection of activeConnections) {
            ...
            const invocation = new Invocation(this.client.getInvocationService(), requestCopy);
    ...
    private deregisterListenerOnTarget(userKey: string,
        ...
        const invocation = new Invocation(this.client.getInvocationService(), clientMessage, Number.MAX_SAFE_INTEGER);
